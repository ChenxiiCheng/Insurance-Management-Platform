...
import UserHomePaymentForm from '../UserHomePaymentForm';
import { createHomePayment } from '../../services/invoice';

const UserHomePaymentComponent = Form.create({ name: 'buy_form' })(
  UserHomePaymentForm
);

class UserHomePayment extends Component {
  buyForm = null;
  handleUserBuy = () => {
...
export default withRouter(UserHomePayment);
